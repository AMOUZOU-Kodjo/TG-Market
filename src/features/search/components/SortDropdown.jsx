    ...
    <div className={cn("relative", className)}>
      <button
        ...
        className={cn(
          ...
          "dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-red-800 dark:hover:text-red-700",
          isOpen && "border-red-800 ring-2 ring-red-800/20"
        )}
      >
        <SlidersHorizontal className="h-4 w-4" />
        <span className="hidden sm:inline">Trier par :</span>
        <span className="text-red-900 dark:text-red-700">{current.label}</span>
        <ChevronDown
          className={cn(
