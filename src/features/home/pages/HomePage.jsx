...
//images de HomePage Héro
  ...
  return (
    <section className="relative h-72 overflow-hidden sm:h-80 lg:h-96">
      ...
      <div className="absolute inset-0 flex items-end justify-center px-4 pb-10 sm:justify-start sm:px-10 sm:pb-14 md:px-16 md:pb-16 lg:px-24 lg:pb-20" style={{ zIndex: 10 }}>
