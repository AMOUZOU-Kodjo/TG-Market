...
L'utilisation de AK Market emporte acceptation pleine et entière des CGU. La version en vigueur est celle publiée dans l'application au jour de l'utilisation. En cas de modification substantielle, AK Market peut exiger une nouvelle acceptation (journalisée) pour continuer à utiliser les services.`,
  },
  {
    icon: Users,
    title: "2. Définitions",
    content: `Utilisateur : Toute personne disposant d'un compte AK Market.
...
Offre : Proposition de prix formalisée via AK Market.

Validation QR : Scan obligatoire du QR code généré lors de la remise du bien.

RDV sécurisé : Point partenaire recommandé par AK Market.

Frais AK Market : Frais de service et de paiement, auxquels s'ajoutent le cas échéant les frais de RDV, de livraison ou de boosts (voir barème dans l'application).
...
Portefeuille / Solde : Affichage des mouvements effectués lors des transactions.`,
  },
  {
    ...
    content: `3.1 Âge et capacité : Le service est réservé aux personnes majeures. Les mineurs ne peuvent utiliser AK Market qu'avec un accord parental formalisé pour les ventes.
...
3.3 KYC et revérification : AK Market peut exiger une pièce d'identité (CNI, permis de conduire) accompagnée d'un selfie, ainsi que tout document complémentaire (justificatif de domicile, RCCM pour les professionnels). AK Market peut suspendre le compte tant que la vérification n'est pas finalisée, ou le résilier en cas d'anomalie ou de faux documents.
...
3.5 Clôture : L'utilisateur peut demander la clôture de son compte. AK Market peut conserver certaines données pour des motifs légaux, de lutte anti-fraude et de preuve (voir notre Politique de confidentialité).`,
  },
  {
    icon: Shield,
    title: "4. Règles de publication et catégories interdites",
    content: `4.1 Esprit « seconde main » et prix raisonnables : AK Market privilégie les biens d'occasion, la transparence sur leur état et des prix cohérents.
...
Seules les catégories visibles dans l'application AK Market sont autorisées. Tout objet dont la catégorie est absente est interdit par principe et sera retiré. Cette liste est évolutive et non exhaustive ; AK Market se réserve le droit de retirer tout objet présentant un risque ou contraire à la loi.
...
4.4 Modération : AK Market peut refuser, retirer ou déréférencer toute annonce, limiter des catégories, exiger des preuves d'origine ou classer les annonces selon des critères de pertinence.

4.5 Professionnels : Leur activité est interdite sauf déclaration préalable et respect des obligations légales. AK Market peut requalifier un compte en « professionnel » et exiger des informations supplémentaires.`,
  },
  {
    icon: MessageSquare,
    title: "5. Processus d'échange, sécurité et interdiction de contournement",
    content: `5.1 Messagerie interne : La négociation doit se faire dans AK Market. Il est interdit d'imposer des canaux de communication externes avant qu'une offre ne soit acceptée.
...
5.3 Validation QR obligatoire : Lors de la rencontre, l'acheteur génère un QR code dans la messagerie, que le vendeur doit scanner. Ce scan valide la transaction (horodatage, lieu, identités), sert de preuve et déclenche le paiement. À défaut, AK Market peut considérer l'échange comme non sécurisé et appliquer des sanctions.

5.4 RDV sécurisés : AK Market recommande des lieux partenaires. L'utilisateur demeure cependant responsable de sa sécurité et de ses biens.
...
• Toute manœuvre visant à éluder les frais AK Market

AK Market se réserve le droit d'appliquer des pénalités, des restrictions, une suspension ou une résiliation du compte.`,
  },
  {
    icon: CreditCard,
    title: "6. Paiements, prix, frais et fiscalité",
    content: `6.1 Moyens de paiement : Selon la disponibilité locale : espèces via livreur (le cas échéant), paiement via AK Market (ex. : Wave, Orange Money, MTN MoMo), carte bancaire et autres.
...
6.5 Réserves et compensations : En cas de risque (fraude, litige, recouvrement), AK Market peut retenir temporairement des fonds, imposer des réserves, compenser des sommes dues ou annuler un paiement.

6.A. « Portefeuille », prestataire de paiement et non-détention de fonds

6.A.1 Nature du « Portefeuille » : Toute fonctionnalité nommée « Portefeuille », « Solde » ou « Crédit » ne constitue pas un compte de paiement ni de la monnaie électronique émise par AK Market. Il s'agit d'un affichage comptable virtuel récapitulant les mouvements traités par un prestataire de services de paiement tiers (PSP).

6.A.2 Absence de détention de fonds par AK Market : AK Market ne reçoit, ne détient, n'encaisse ni ne garde de fonds au nom des utilisateurs. Les flux financiers sont exclusivement traités par le PSP.

6.A.3 Statut d'AK Market : AK Market n'est pas un établissement de crédit, de monnaie électronique ou de paiement. AK Market n'exerce aucune activité réglementée de services de paiement.
...
6.A.5 Consentement et partage de données : L'utilisateur autorise AK Market à transmettre au PSP les données nécessaires à la transaction. Des vérifications supplémentaires peuvent être requises par le PSP.

6.A.6 Absence d'intérêts et d'assurance : Aucun intérêt n'est versé sur les montants en transit. AK Market n'assure pas les fonds.

6.A.7 Erreurs de paiement et litiges financiers : Tout incident de paiement doit être signalé immédiatement via l'application et au PSP concerné. AK Market coopère mais n'est pas responsable des dysfonctionnements du PSP.

6.A.8 Blocages et conformité : Dans le cadre de la lutte contre la fraude et le blanchiment d'argent, le PSP et/ou AK Market peuvent bloquer une opération, demander des justificatifs ou refuser une transaction.
...
6.A.11 Absence de service « escrow » : AK Market ne fournit aucun service de séquestre (escrow). Toute fonctionnalité de blocage de fonds est gérée par le PSP.

6.A.12 Disponibilité et maintenance : Les fonctionnalités de paiement peuvent être temporairement indisponibles. AK Market n'est pas responsable des retards qui en résultent.
...
6.A.14 Sécurité des données de paiement : Les données de paiement sensibles sont traitées par le PSP selon les normes en vigueur (ex. : PCI DSS). AK Market n'y a pas accès.

6.A.15 Fraude et responsabilité : La responsabilité d'AK Market liée aux paiements se limite aux frais de service perçus pour la transaction concernée.

6.B. Tarification et barème

En contrepartie de l'utilisation du paiement sécurisé AK Market, l'Acheteur s'acquitte de Frais de Service et de Paiement, qui s'ajoutent au prix du bien. Le montant total est indiqué avant la validation du paiement. Un montant minimum est appliqué.

Révision des tarifs : AK Market peut ajuster le barème avec un préavis via l'application. La nouvelle grille s'applique aux offres créées après sa date d'entrée en vigueur.`,
  },
  {
    icon: Share2,
...
8.3 Litiges : L'ouverture d'un litige doit se faire sous 24 à 48 h avec des preuves (photos, vidéos, etc.). AK Market peut proposer une médiation mais la décision finale appartient aux parties ou à la loi.

8.4 Recouvrements (Chargebacks) et fraude : En cas de contestation de paiement, AK Market peut bloquer les fonds, demander des preuves et débiter le vendeur si la contestation est perdue.`,
  },
  {
    icon: Scale,
    title: "9. Responsabilités et garanties",
    content: `9.1 Rôle d'AK Market : AK Market est un intermédiaire technique qui héberge des annonces. AK Market n'est pas partie aux ventes et ne garantit ni l'existence ni la conformité des biens.
...
9.4 Limitation de responsabilité : Dans les limites autorisées par la loi, la responsabilité d'AK Market est plafonnée au montant des frais perçus sur la transaction concernée.

9.5 Force majeure et maintenance : AK Market n'est pas responsable des pannes de réseaux externes ni des interruptions nécessaires à la maintenance.`,
  },
  {
    icon: Ban,
    title: "10. Lutte anti-fraude, sanctions et mesures",
    content: `10.1 Contrôles : AK Market peut analyser les annonces et les comportements, et demander des preuves d'achat ou d'identité.
...
10.3 Signalements et coopération : AK Market peut signaler toute activité suspecte aux autorités compétentes et coopérer avec elles.`,
  },
  {
    icon: Gavel,
    title: "11. Contenus et propriété intellectuelle",
    content: `11.1 Droits d'AK Market : Les marques, logos, designs, bases de données et logiciels sont la propriété exclusive d'AK Market.

11.2 Licence utilisateur : En publiant du contenu, l'utilisateur concède à AK Market une licence non exclusive, gratuite et mondiale pour l'héberger, le reproduire et le communiquer aux fins d'exploitation et de promotion de l'application.

11.3 Contrefaçon et procédure de retrait : Tout titulaire de droits peut notifier un contenu illicite à support@akmarket.tg. AK Market appliquera la procédure de notification et de retrait appropriée.`,
  },
  {
    icon: Lock,
...
14.3 Enregistrement : AK Market conserve les journaux d'acceptation des différentes versions des CGU.`,
  },
  {
    icon: FileText,
    title: "15. Durée, résiliation et survie",
    content: `AK Market peut résilier ou suspendre un compte sans préavis en cas de manquement grave, de fraude ou de risque manifeste. Les clauses relatives à la responsabilité, la propriété intellectuelle, aux données et à la preuve survivent à la résiliation.`,
  },
  {
    icon: Gavel,
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-sm leading-relaxed text-red-950 dark:text-red-400">
            Ces conditions régissent ton utilisation de la plateforme AK Market.
